...
This means you are guaranteed to have a fellowship, Graduate Research Assistantship (GRAs), Teaching Assistantship (TA), or other means of support throughout your time at Cornell. 
...
GRA/RA generally means some sort of grant, gift, or research award is supporting your work. Again, it is my role to raise this money to support your research, or to fit your research into funding that I already have (more below on choosing research directions). While it is possible that you will be asked to do an RA role that is not related to your research, it is hopefully not very likely. It is also possible that later in the PhD I will ask you (or you will initiate) for your help in writing a grant proposal in your area. This would be great practice for you as a future academic.  

GRA and TA both represent a certain bounded amount of work in terms of hours per week. In both cases, your PhD work should fill the rest of your weekly hours. 

I do expect you to apply for appropriate fellowships during your PhD. Such fellowships include, for example, the NSF Graduate Fellowship, or corporate fellowships like Microsoft’s. These applications do not usually require too much work, and as a side benefit they require you to articulate your research vision and interests. When you get one, everyone benefits: you are more flexible in your work to pursue your research direction without the pull of funding needs; I spend more time with you and less time getting grants; and you get recognition that goes on your CV.  
...
Cornell Tech has an open space layout where my students and I sit next to each other. You will have an assigned desk in that space. I spend as much time as I can in that space, i.e. whenever I don't need to be in my meeting huddle (a few steps away), or in other meetings. I expect most students to be working from the open space regularly, which is not to say "most of the time" but perhaps a substantial portion of the working hours each week, overall aiming to be present in the office at least three days a week. 

If work and progress get done, it does not matter where you are on any given day. But I find that progress and problem solving are more likely when you are surrounded by others (including me) who can help solve problems, answer questions, and point you in a helpful direction. More importantly, co-presence creates a collaborative environment in which you and your peers can support each other and exchange ideas. Group members often lightly coordinate the weekdays when they are around. 
...
There are [specific guidelines provided by Cornell](https://gradschool.cornell.edu/policies/vacation-time-for-assistantships/), and Ph.D. students in my group are encouraged to take as much various holiday breaks and vacations as they can. I strongly encourage that you take as many days off as is allowed by the official policy. If I could insist that you take _at least_ 4 weeks, I would; if you need more, well, we can make it work but you still need to make progress (and again, any time off should align with policies and funding restrictions). Vacation should mean _vacation_: no work email (or just monitoring for urgent needs), no working on papers, no analyzing data. Note that conference travel does not (and should not) count as vacation. You can also take leave, for example during summer if you are not funded (see note on internships below). I took the second summer of my PhD off to travel the world for three months.
...
If I'm not there in person at work, you can try to find me in multiple ways. First, Slack. In particular, our lab's Slack team is the best way to find me. I have alerts setup for the lab Slack team (and only the lab Slack team) on my phone, too, in case you need a quick response for a question or request (with the caveats above).  I am also of course available by email. However, email is not a synchronous medium, and I often turn it off in order to get stuff done, and stuff tends to get lost there due to volume. Always expect that I may not respond for 24-48 hours to any email you send during normal times; it will take longer when I’m traveling.
...
See below for notes about using AI for writing (and research). 
...
AI can be used to expand the scope of research and help us produce better work, but its use must be disclosed, and you remain responsible for any aspect of the work. 

In research, AI chatbots and research tools can be helpful for generating ideas, suggesting approaches to problems, writing code, etc. You should let me know when and how you used AI tools in our projects -- it is perfectly fine to do, and I encourage you to do it. However, misuse or careless use carries serious risks, and it is your responsibility to *fully understand and verify any AI‑generated output*.

It is OK to use ChatGPT or similar AI technologies to assist in various ways in the writing process, but you should tell me that you are doing it so I can give you the right level of feedback. Also, I recommend using AI only for grammar and minor edits. You should already know what you want to say in each paragraph. Do not use AI for a first draft or outline. For example, when writing about related work, you should first outline what you think are the key areas and papers to cover; only then may you ask AI for additional suggestions. If you send me a draft, I am likely to prefer to first see your pre‑AI notes. Do not send me AI‑improved or AI‑generated text, code, or analysis without clearly marking it as such. 

You may borrow reference ideas from AI, but you should not cite or rely on work you have not personally read. Do not take citation code or text directly from AI; always go to the paper source for proper citation text. Again, you are responsible for *fully verifying any AI-written output*. If there is any content—paragraphs, sentences, quotes, or references—that you cannot explain or support, I will not be able to trust the work.

In summary: (1) the output of whatever writing process is your responsibility, regardless of whether AI helped or not. You should be able to justify every single word, sentence or argument, 100%, no excuses, at any time; (2) especially in your first years, I highly recommend writing and structuring text yourself to have a better appreciation of what makes good writing; (3) when you do use AI, you should think about what you want to write and give the AI a template or draft text to improve upon. Of course, you should always follow the submission venue's policies regarding use of AI and disclosure. 
...
If you or someone you know is feeling overwhelmed, depressed, and/or in need of support, services are available at Cornell and Cornell Tech to support you. These services range from a student affairs team member available to discuss your challenges, to professional outside services offered through your student health insurance. You can find more details on the [Cornell Tech](https://studentaffairs.tech..edu/health-wellness/nyc-health-resources/) and [Cornell](https://health.cornell.edu/services/mental-health-care) websites. 
...
I usually have research assistantship support for students who are interested in sticking around for the summer. Yo will need to talk to me about it early (Fall) to assist planning.

Students in our area often look for internships at major companies. Within these companies, there are a wide spectrum of intern roles—from pure research to pure development. You will likely prefer the former over the latter (the former can lead to papers; though that is often not incentivized within companies). While it varies by place, students sometimes line up internships as early as October before the summer they intern, though that process can and does go into March or even April. Again, it varies by company and stage in the program. If there is a certain place you’d like to intern, ask me: I may know someone there and can make an introduction.

Internships at nonprofits, government agencies, or startups can be especially exciting. They may require more initiative to find, but they often offer more varied roles once you’re there.
...
### Disclaimers, Credits, and Related Information
As noted above, this is not an official document and may not be updated as frequently as policies might change. Cornell students should refer to their official PhD programs (see [Information Science](https://infosci.cornell.edu/phd) and [Computer Science](https://www.cs.cornell.edu/phd)) and the [graduate school](https://gradschool.cornell.edu/) for official guidelines, policies, and information. 
